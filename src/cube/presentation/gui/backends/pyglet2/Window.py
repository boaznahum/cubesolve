...
class Window(pyglet.window.Window, AnimationWindow):
    ...
    def update_text(self) -> None:
        ...
        self.text.append(pyglet.text.Label(s,
                                           x=10, y=y, font_size=10, color=(255, 0, 0, 255), weight='bold'))
        y += 20
        ...
        self.text.append(pyglet.text.Label(s,
                                           x=10, y=y, font_size=10, color=(255, 255, 0, 255), weight='bold'))
        y += 20
        ...
        self.text.append(pyglet.text.Label(s,
                                           x=10, y=y, font_size=10, color=(0, 255, 0, 255), weight='bold'))
        y += 20
        ...
        self.text.append(pyglet.text.Label(s, x=10, y=y, font_size=15, color=(0, 255, 0, 255), weight='bold'))
        y += 20
        ...
        for i in range(3):
            ...
            if h:
                ...
                self.animation_text.append(pyglet.text.Label(h,
                                                             x=x, y=y, font_size=size, color=color, weight=weight))
