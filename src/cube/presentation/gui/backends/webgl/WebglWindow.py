...
class WebglTextRenderer(TextRenderer):
    """Text renderer for webgl backend.
...
class WebglWindow(Window):
    """WebGL window representing browser canvas.
    ...
    def __init__(self, width: int, height: int, title: str):
        ...
        # Text renderer
        self._text_renderer = WebglTextRenderer()
    ...
    @property
    def text(self) -> WebglTextRenderer:
