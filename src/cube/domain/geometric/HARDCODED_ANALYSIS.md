...
| 2.3 | `_SLICE_FACES` | _CubeGeometric.py | **MOVE** | Move to cube_layout.py or derive |
...
- **2.1-2.3** Move `_SLICE_ROTATION_FACE`, `_AXIS_ROTATION_FACE`, `_SLICE_FACES` from `_CubeGeometric.py`
