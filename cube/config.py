...
##############  Testing
TEST_NUMBER_OF_SCRAMBLE_ITERATIONS = 200
AGGRESSIVE_TEST_NUMBER__SIZES = [3, 6, 7]
#AGGRESSIVE_TEST_NUMBER__SIZES = [6,]
AGGRESSIVE_TEST_NUMBER_OF_SCRAMBLE_START = 0
AGGRESSIVE_TEST_NUMBER_OF_SCRAMBLE_ITERATIONS = 200 * len(AGGRESSIVE_TEST_NUMBER__SIZES)
