...
class NxNCentersFaceTrackers(SolverElement):
    ...
    def _track_no_1(self) -> FaceLoc:
        ...
        if cube.n_slices % 2:
            ...
            return FaceLoc.search_by_index_and_track(f, _slice.index)
    ...
    def _track_no_3(self, two_first: Sequence[FaceLoc]) -> FaceLoc:
        ...
        return FaceLoc.search_color_and_track(f3, f3_color)
    ...
    def _track_two_last(self, four_first: Sequence[FaceLoc]) -> Tuple[FaceLoc, FaceLoc]:
        ...
        f5_track = FaceLoc.by_pred(cube, color, pred)
    ...
    def _track_odd(self, f: Face) -> FaceLoc:
        ...
        return FaceLoc.by_pred(self.cube, color,pred)



    @staticmethod
    def _is_track_slice(s: CenterSlice):
        return FaceLoc.is_track_slice(s)
    ...
    def _remove_all_track_slices(self):
        ...
        for f in self.cube.faces:
            FaceLoc.remove_face_track_slices(f)
